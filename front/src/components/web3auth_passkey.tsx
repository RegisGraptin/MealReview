...
const clientId = "BJhn9PinJyqJCmli9UC4mFPpJ4Mrsi7WxRCcFqmzrr5fpvoi6WeD3wYKtMDZc6kAfRQPTSgpDU13d4gTnJAgUSc"; // get from https://dashboard.web3auth.io
...
//   };
  ...
  const logoutView = (
    <>
      ...
      {/* <button onClick={GoogleLogin} className="card passkey">
        Login with Passkey
      </button> */}
    </>
  );
...
export default passkeyWeb3Auth;