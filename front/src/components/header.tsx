...
import passkeyWeb3Auth from './web3auth_passkey';
import SfaWeb3Auth from './web3auth_sfa'
                ...
                <nav className="border-gray-200 px-4 lg:px-6 py-2.5">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <a href="/" className="flex items-center">
                            <img src="../images/logo.svg" className="mr-3 h-6 sm:h-16" alt="Meal Review" />
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            <ConnectButton />
                            <GoogleLogin onSuccess={SfaWeb3Auth} />
                            {/* <button onClick={() => passkeyWeb3Auth()}>web3auth</button> */}
                        ...
                        <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                ...
                                <li>
                                    <Link href="/restaurant" className="block py-2 pr-4 pl-3 rounded lg:text-primary-700 lg:p-0" >
                                        Restaurant
                                    </Link>
                                </li>
                            </ul>
